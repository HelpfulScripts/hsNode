...
//     const result:any = (prefix:string) => create(prefix,);
//     result.DEBUG    = util.log.DEBUG;
//     result.INFO     = util.log.INFO;
//     result.WARN     = util.log.WARN;
//     result.ERROR    = util.log.ERROR;
//     result.level    = util.log.level;
//     result.debug    = util.log.debug;
//     result.info     = util.log.info;
//     result.warn     = util.log.warn;
//     result.error    = util.log.error;
//     result.format   = util.log.format;
//     result.prefix   = util.log.prefix;
//     result.out      = util.log.out;
//     result.logFile  = util.log.logFile;
//     result.config   = util.log.config;
//     result.inspect  = util.log.inspect;
//     result.logToFile  = node_logToFile;
//     result.pathExists = node_pathExists;
//     return result;
// }
