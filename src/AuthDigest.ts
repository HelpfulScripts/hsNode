...
import { Options, IncomingMessage, Auth, Authenticators, Credentials }          
                        from 'hsutil';
...
Authenticators.addAuthProvider('Digest', (credentials:Credentials):Auth => new AuthDigest(credentials.user, credentials.password))